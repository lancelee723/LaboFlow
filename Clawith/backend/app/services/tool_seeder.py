...
# LightRAG native tool declarations (seed as builtin tools so agents can use them).
LIGHTRAG_TOOLS = [
    {
        "name": "lightrag.query",
        "display_name": "LightRAG: Query",
        "description": "Run a RAG query (non-streaming).",
        "category": "rag",
        "icon": "🧠",
        "is_default": False,
        "parameters_schema": {
            ...
            "properties": {
                ...
                "mode": {"type": "string", "description": "Query mode (local/global/hybrid/mix/naive)"},
                "top_k": {"type": "integer", "description": "Top K results"},
        ...
        "config": {"base_url": "http://localhost:9621", "api_key": ""},
        "config_schema": {
            "fields": [
                {"key": "api_key", "label": "LightRAG API Key", "type": "password", "default": ""},
                {"key": "base_url", "label": "LightRAG Base URL", "type": "text", "default": "http://localhost:9621"},
            ]
        },
    },
    {
        "name": "lightrag.query.data",
        "display_name": "LightRAG: Query Data",
        "description": "Get structured retrieval data (entities/relations/chunks).",
        "category": "rag",
        "icon": "🧾",
        "is_default": False,
        "parameters_schema": {"type": "object", "properties": {"query": {"type": "string"}}, "required": ["query"]},
        "config": {"base_url": "http://localhost:9621", "api_key": ""},
        "config_schema": {"fields": [{"key": "api_key", "label": "API Key", "type": "password", "default": ""}]},
    },
    {
        "name": "lightrag.documents.text",
        "display_name": "LightRAG: Insert Text",
        "description": "Insert a single text document into LightRAG (async indexing).",
        "category": "documents",
        "icon": "📝",
        "is_default": False,
        "parameters_schema": {"type": "object", "properties": {"text": {"type": "string"}, "file_source": {"type": "string"}}, "required": ["text"]},
        "config": {"base_url": "http://localhost:9621", "api_key": ""},
        "config_schema": {"fields": [{"key": "api_key", "label": "API Key", "type": "password", "default": ""}]},
    },
    {
        "name": "lightrag.documents.texts",
        "display_name": "LightRAG: Insert Texts",
        "description": "Insert multiple text documents into LightRAG.",
        "category": "documents",
        "icon": "📚",
        "is_default": False,
        "parameters_schema": {"type": "object", "properties": {"texts": {"type": "array", "items": {"type": "string"}}, "file_sources": {"type": "array", "items": {"type": "string"}}}, "required": ["texts"]},
        "config": {"base_url": "http://localhost:9621", "api_key": ""},
        "config_schema": {"fields": [{"key": "api_key", "label": "API Key", "type": "password", "default": ""}]},
    },
    {
        "name": "lightrag.documents.list",
        "display_name": "LightRAG: List Documents",
        "description": "List uploaded documents and their statuses.",
        "category": "documents",
        "icon": "📄",
        "is_default": False,
        "parameters_schema": {"type": "object", "properties": {}},
    ...
    {
        "name": "lightrag.documents.clear",
        "display_name": "LightRAG: Clear Documents",
        "description": "Clear documents or caches in LightRAG.",
        "category": "documents",
        "icon": "🧹",
        "is_default": False,
        "parameters_schema": {"type": "object", "properties": {}},
    ...
    {
        "name": "lightrag.graph.get",
        "display_name": "LightRAG: Get Graph",
        "description": "Retrieve a knowledge subgraph for a label.",
        "category": "graph",
        "icon": "🔗",
        "is_default": False,
        "parameters_schema": {"type": "object", "properties": {"label": {"type": "string"}, "max_depth": {"type": "integer"}}},
        "config": {"base_url": "http://localhost:9621", "api_key": ""},
        "config_schema": {"fields": [{"key": "api_key", "label": "API Key", "type": "password", "default": ""}]},
    },
    {
        "name": "lightrag.graph.label.search",
        "display_name": "LightRAG: Search Labels",
        "description": "Search graph labels (fuzzy).",
        "category": "graph",
        "icon": "🔎",
        "is_default": False,
        "parameters_schema": {"type": "object", "properties": {"q": {"type": "string"}, "limit": {"type": "integer"}}, "required": ["q"]},
        "config": {"base_url": "http://localhost:9621", "api_key": ""},
        "config_schema": {"fields": [{"key": "api_key", "label": "API Key", "type": "password", "default": ""}]},
    },
    {
        "name": "lightrag.graph.entity.exists",
        "display_name": "LightRAG: Entity Exists",
        "description": "Check whether an entity exists in the knowledge graph.",
        "category": "graph",
        "icon": "❓",
        "is_default": False,
    ...
    {
        "name": "lightrag.graph.entity.create",
        "display_name": "LightRAG: Create Entity",
        "description": "Create an entity in the knowledge graph.",
        "category": "graph",
        "icon": "➕",
        "is_default": False,
        "parameters_schema": {"type": "object", "properties": {"entity_name": {"type": "string"}, "entity_data": {"type": "object"}}, "required": ["entity_name", "entity_data"]},
        "config": {"base_url": "http://localhost:9621", "api_key": ""},
        "config_schema": {"fields": [{"key": "api_key", "label": "API Key", "type": "password", "default": ""}]},
    },
    {
        "name": "lightrag.graph.entity.edit",
        "display_name": "LightRAG: Edit Entity",
        "description": "Edit an entity's properties in the knowledge graph.",
        "category": "graph",
        "icon": "✏️",
        "is_default": False,
        "parameters_schema": {"type": "object", "properties": {"entity_name": {"type": "string"}, "updated_data": {"type": "object"}}, "required": ["entity_name", "updated_data"]},
        "config": {"base_url": "http://localhost:9621", "api_key": ""},
        "config_schema": {"fields": [{"key": "api_key", "label": "API Key", "type": "password", "default": ""}]},
    },
    {
        "name": "lightrag.graph.relation.create",
        "display_name": "LightRAG: Create Relation",
        "description": "Create a relation between two entities.",
        "category": "graph",
        "icon": "🔗",
        "is_default": False,
        "parameters_schema": {"type": "object", "properties": {"source_entity": {"type": "string"}, "target_entity": {"type": "string"}, "relation_data": {"type": "object"}}, "required": ["source_entity", "target_entity", "relation_data"]},
        "config": {"base_url": "http://localhost:9621", "api_key": ""},
        "config_schema": {"fields": [{"key": "api_key", "label": "API Key", "type": "password", "default": ""}]},
    },
    {
        "name": "lightrag.graph.entities.merge",
        "display_name": "LightRAG: Merge Entities",
        "description": "Merge duplicate entities into a single target.",
        "category": "graph",
        "icon": "🧩",
        "is_default": False,
        "parameters_schema": {"type": "object", "properties": {"entities_to_change": {"type": "array", "items": {"type": "string"}}, "entity_to_change_into": {"type": "string"}}, "required": ["entities_to_change", "entity_to_change_into"]},
        "config": {"base_url": "http://localhost:9621", "api_key": ""},
        "config_schema": {"fields": [{"key": "api_key", "label": "API Key", "type": "password", "default": ""}]},
    },
]
