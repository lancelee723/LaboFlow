        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col gap-2">
            {project.status === "completed" && (
              <a href={`/api/projects/${id}/export.pptx`} className="inline-flex h-10 w-full items-center justify-center gap-2 rounded-md border border-input bg-background px-4 py-2 text-sm font-medium ring-offset-background transition-colors hover:bg-accent hover:text-accent-foreground">
