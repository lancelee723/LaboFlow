...
const cosCheckResult = ref<{ ok: boolean; message: string; bucket_created?: boolean } | null>(null)
const checkingTos = ref(false)
const tosCheckResult = ref<{ ok: boolean; message: string; bucket_created?: boolean } | null>(null)
const checkingS3 = ref(false)
const s3CheckResult = ref<{ ok: boolean; message: string; bucket_created?: boolean } | null>(null)
const checkingOss = ref(false)
const ossCheckResult = ref<{ ok: boolean; message: string; bucket_created?: boolean } | null>(null)
const checkingKs3 = ref(false)
const ks3CheckResult = ref<{ ok: boolean; message: string; bucket_created?: boolean } | null>(null)
const checkingObs = ref(false)
const obsCheckResult = ref<{ ok: boolean; message: string; bucket_created?: boolean } | null>(null)
