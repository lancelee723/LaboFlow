export default {
  ...
  knowledgeBase: {
    ...
    uploadResultTitle: 'Upload Results',
    uploadResultSummary: '{success} succeeded, {skipped} skipped, {failed} failed.',
    uploadSkippedFilesTitle: 'Skipped Files',
    uploadFailedFilesTitle: 'Failed Files',
    uploadReasonHiddenFile: 'Hidden files or files inside hidden folders were filtered out',
    uploadReasonVideoUnsupported: 'Video upload is not supported yet',
    uploadReasonImageRequiresVlm: 'VLM is disabled, so image files were skipped',
    uploadReasonAudioRequiresAsr: 'ASR is disabled, so audio files were skipped',
    uploadReasonNoParser: 'No available parser engine supports this file type in the current knowledge base',
