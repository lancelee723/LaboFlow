export default {
  ...
  knowledgeBase: {
    ...
    uploadResultTitle: "업로드 결과",
    uploadResultSummary: "성공 {success}개, 건너뜀 {skipped}개, 실패 {failed}개.",
    uploadSkippedFilesTitle: "건너뛴 파일",
    uploadFailedFilesTitle: "업로드 실패 파일",
    uploadReasonHiddenFile: "숨김 파일 또는 숨김 폴더 내부 파일이 필터링되었습니다",
    uploadReasonVideoUnsupported: "동영상 업로드는 아직 지원되지 않습니다",
    uploadReasonImageRequiresVlm: "VLM이 비활성화되어 이미지 파일이 건너뛰어졌습니다",
    uploadReasonAudioRequiresAsr: "ASR이 비활성화되어 오디오 파일이 건너뛰어졌습니다",
    uploadReasonNoParser: "현재 지식베이스에서 이 파일 형식을 처리할 수 있는 파서 엔진이 없습니다",
    uploadFile: "파일 업로드",
    ...
    columnActions: "작업",
    treeDocumentCount: "파일 {count}개",
    selectAll: "전체 선택",
    selectedCount: "{count}개 선택됨",
    clearSelection: "선택 해제",
    batchUpdateTag: "일괄 분류",
    batchUpdateTagTip: "선택한 {count}개 문서에 분류를 설정합니다",
    batchDelete: "선택 삭제",
