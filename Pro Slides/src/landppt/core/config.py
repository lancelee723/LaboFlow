...
class AppConfig(BaseSettings):
    ...
    # Clawith SSO Configuration
    sso_enabled: bool = Field(default=False, env="PRO_SLIDES_SSO_ENABLED")
    sso_jwt_secret: Optional[str] = Field(default=None, env="PRO_SLIDES_SSO_SECRET")
    sso_jwt_audience: str = Field(default="pro-slides", env="PRO_SLIDES_SSO_AUDIENCE")
    sso_jwt_algorithm: str = Field(default="HS256", env="PRO_SLIDES_SSO_ALGORITHM")
